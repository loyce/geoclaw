! :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
! :::::   Modified from geoclaw valout.f
! :::::   Adds inner product to output
! :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
c
c -----------------------------------------------------
c
...
c     # set outaux = .true. to also output the aux arrays to fort.a<iframe>
      ...
      real(kind=8) :: h, hu, hv, eta, x_c, y_c, innerprod
      real(kind=8), allocatable :: qeta(:), qmod(:)
     ...
     .                                      naux*mitot*(j-1)
      ...
      iaddqmod(ivar,i,j)  = 1 + ivar - 1 + 5*((j-1)*mitot+i-1)
c
        ...
        if (output_format == 1) then
             do j = nghost+1, mjtot-nghost
                do i = nghost+1, mitot-nghost
                   ...
                   write(matunit1,109) h,hu,hv,eta,innerprod
                enddo
                write(matunit1,*) ' '
             enddo
  109        format(50e26.16)
...
c            # Need to augment q with eta and max innerproduct:
             allocate(qmod(5*mitot*mjtot))
             do j=1,mjtot
                 do i=1,mitot
                    do m=1,3
...
c     # Print meqn = nvar+2 because eta and max innerproduct were added.
      write(matunit2,1000) time,nvar+2,ngrids,naux,ndim,nghost
